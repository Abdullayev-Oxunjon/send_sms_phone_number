...
from app.serializer.forgot_password_serializer import ForgotPasswordModelSerializer, ForgotChangeUserModelSerializer
from app.utils import generate_verification_code, send_forgot_password_phone_number
...
class ForgotPasswordView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            send_forgot_password_phone_number(body=f"Tasdiqlash kodi : {verification_code}",
                                              number=phone_number)
